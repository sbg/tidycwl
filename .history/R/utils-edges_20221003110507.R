...
get_cwl_version_steps <- function(steps) {
  ...
  if (is.null(ver)) {
    if (ver_1_0_str_gbl %in% get_el_from_list(get_el_from_list(steps, "run"), "cwlVersion")) ver <- ver_1_0_str_gbl
    if (ver_1_1_str_gbl %in% get_el_from_list(get_el_from_list(steps, "run"), "cwlVersion")) ver <- ver_1_1_str_gbl
    if (ver_1_2_str_gbl %in% get_el_from_list(get_el_from_list(steps, "run"), "cwlVersion")) ver <- ver_1_2_str_gbl
    if (sbg_draft_str_gbl %in% get_el_from_list(get_el_from_list(steps, "run"), "cwlVersion")) ver <- sbg_draft_str_gbl
  }
  ver
}
